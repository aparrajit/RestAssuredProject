...
public class GetStudent {
	...
	public void test1() {
		...
		Response response = RestAssured.given().auth().oauth2(accessToken)
				.baseUri("http://44.212.38.181:8088/students/2").when().get();
	...
	public String GetOAuthToken() {
		...
		Response response = RestAssured.given().baseUri("http://44.212.38.181:8088/").auth().preemptive()
